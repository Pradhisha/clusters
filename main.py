...
coloumn_names = ["CabinNum","Fname","Lname","Age","Survived","Lat","Long","PictureCap","PicturePas","Fare"]
myfile = open("minnow.csv","r")
...
def main():
		...
		return render_template('index.html',cdist=cdist,pdict=pdict, disCluster = disCluster,response_time=response_time)
